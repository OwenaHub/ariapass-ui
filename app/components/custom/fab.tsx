...
export default function FAB() {
    ...
    // 1. Close the FAB if the user clicks anywhere outside of it
    useEffect(() => {
    ...
    // 2. Detect scrolling to make the FAB transparent
    useEffect(() => {
    ...
    return (
        ...
        >
            ...
            <div
                // Mobile: Stacked Column | Desktop: 2x2 Grid
            ...
            >
                {actions.map((action, index) => {
                    // Staggered delay for that premium native app feel
            ...
            >
                <RiAddLine
                    size={28}
                    className={`transition-transform duration-300 ease-in-out ${isOpen ? "rotate-135" : "rotate-0"}`}
                />
            </button>
        </div>
    );
