          ...
          <SidebarGroup key={calendar.name}>
            ...
            >
              ...
              >
                <CollapsibleTrigger>
                  {calendar.name}{" "}
                  <RiArrowRightSLine className="ms-auto transition-transform group-data-[state=open]/collapsible:rotate-90" />
                </CollapsibleTrigger>
              </SidebarGroupLabel>
              <CollapsibleContent>
                <SidebarGroupContent>
                    ...
                    {calendar.items.map((item, index) => (
                      <SidebarMenuItem key={item}>
                        <SidebarMenuButton>
                          ...
                          >
                            <RiCheckLine className="hidden size-3 group-data-[active=true]/calendar-item:block" />
                          </div>
                          {item}
                        </SidebarMenuButton>
                      </SidebarMenuItem>
