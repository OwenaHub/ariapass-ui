...
export default function MobileNav() {
    ...
    return (
        ...
        <>
            {pathLength.length < 2 && (
                <nav className="md:hidden fixed bottom-2 left-1/2 -translate-x-1/2 z-50 w-[95%] rounded bg-white/80 backdrop-blur-lg border border-gray-100 shadow-[0_-4px_50px_-1px_rgba(0,0,0,0.1)] pb-[env(safe-area-inset-bottom)]">
