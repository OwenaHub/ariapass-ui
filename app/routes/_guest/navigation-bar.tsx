                ...
                <div className="container py-0">
                    <div className="flex justify-between items-center h-16 relative w-full">
                        ...
                        <div className="flex items-center">
                            ...
                            <Link to="/" onClick={closeMenu} className='pointer-cursor hidden md:flex flex-col items-center z-50'>
                        ...
                        <Link to="/" onClick={closeMenu} className='pointer-cursor md:hidden absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-50'>
