        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-6 text-sm font-medium">
              ...
              <Link to={""} className="text-gray-600 hover:text-[#f05537] transition-colors flex items-center gap-1">
                Find my tickets
              </Link>
              <Link to={""} className="text-gray-600 hover:text-[#f05537] transition-colors">
                Organisers
              </Link>
              <Link to={""} className="text-gray-600 hover:text-[#f05537] transition-colors">
                Register
