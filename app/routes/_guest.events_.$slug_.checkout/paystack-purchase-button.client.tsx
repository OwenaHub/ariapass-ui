        ...
        <div className="animated fadeIn">
            <div className="mt-0">
                                    ...
                                    <div className="flex-1 flex items-center justify-between border-b border-gray-300 bg-white text-primary p-2 rounded">
                                        ...
                                        <div>
                                            <ButtonGroup orientation="horizontal" className="h-fit">
                                                ...
                                                <Button
                                                    disabled={isSubmitting || (ticket.quantityAvailable - ticket.ticketPurchases <= form.quantity)}
                                                    className="mx-0.5"
                                                    onClick={() => {
                                                        setForm((i) => ({
                                                            ...i,
                ...
                <div className="relative w-full pt-4">
                    <PaystackButton
                        {...componentProps}
                        disabled={form.name.length < 2 || form.email.length < 5 || form.phone.length < 11 || isSubmitting || (totalAmount === 0)}
                        className="flex items-center justify-center w-full px-5 py-2.5 text-sm font-semibold text-white whitespace-nowrap select-none rounded cursor-pointer transition-all duration-75 outline-none disabled:cursor-not-allowed disabled:opacity-50 bg-linear-to-b from-[#303030] to-[#1a1a1a] shadow-[inset_0_2px_0_rgba(255,255,255,0.15),0_0_0_1px_#000000,0_2px_0_0_#000000] active:translate-y-0.5 active:shadow-[inset_0_2px_2px_rgba(0,0,0,0.9),0_0_0_1px_#000000,0_0px_0_0_#000000] disabled:translate-y-0.5 disabled:shadow-[inset_0_2px_2px_rgba(0,0,0,0.9),0_0_0_1px_#000000,0_0px_0_0_#000000] hover:opacity-90"
                    />
